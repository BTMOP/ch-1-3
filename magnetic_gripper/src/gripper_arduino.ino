...
ros::Subscriber<std_msgs::Bool> drop_signal("/Quad3/gripper_command", &sub); //  Subscriber declaration
ros::Publisher decision("/Quad3/gripper_status",&decision_msg);  //  Publisher "gripper_status" declaration
...
void setup() 
{
  ...
  pinMode(pushButton1_1, INPUT_PULLUP);
  pinMode(pushButton1_2, INPUT_PULLUP);
  pinMode(pushButton1_3, INPUT_PULLUP);
  pinMode(pushButton1_4, INPUT_PULLUP);
  pinMode(pushButton2_1, INPUT_PULLUP);
  pinMode(pushButton2_2, INPUT_PULLUP);
  pinMode(pushButton2_3, INPUT_PULLUP);
  pinMode(pushButton2_4, INPUT_PULLUP);
  pinMode(pushButton3_1, INPUT_PULLUP);
  pinMode(pushButton3_2, INPUT_PULLUP);
  pinMode(pushButton3_3, INPUT_PULLUP);
  pinMode(pushButton3_4, INPUT_PULLUP);
  pinMode(PWM1, OUTPUT);
  pinMode(PWM2, OUTPUT);
  pinMode(PWM3, OUTPUT);
